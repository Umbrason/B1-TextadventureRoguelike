...
public class RaiseStonewall : ISkill, ISkillWithRange, ISkillWithRadius
{
    public string Description => "Create an inpenetrable stone wall between two positions in sight.";
    ...
    public void Execute(CombatState combatState, ICombatActor user, params object[] parameters)
    {
        ...
        foreach (var pos in line) combatState.SetTileModifier(pos, new Stonewall());
    }
}