...
public class CombatRenderPipeline
{
    ...
    public string DrawCombat(CombatState state)
    {
        var ScreenBuffer = new CharBuffer(state.Room.Width, state.Room.Height);
    ...
    public interface IRenderPass
    {
        public struct RenderingData
        {
            ...
            public RenderingData(CombatState state, CharBuffer screenBuffer)
            {
