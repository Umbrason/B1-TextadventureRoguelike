...
public static class StreamUtil
{
    ...
    public static void WriteClampedInt(this Stream stream, ClampedInt value)
    {
        stream.WriteInt(value.Min);
        stream.WriteInt(value.Max);
        stream.WriteInt(value.Value);
    }
    public static ClampedInt ReadClampedInt(this Stream stream)
    {
        return new(
            stream.ReadInt(),
            stream.ReadInt(),
    ...
    public static void WriteIBinarySerializable<T>(this Stream stream, T serializable) where T : IBinarySerializable
        => WriteIBinarySerializable(stream, (IBinarySerializable)serializable);
    ...
    private static void WriteIBinarySerializableData(this Stream stream, IBinarySerializable serializable)
        => stream.WriteEnumerable(serializable.ByteData, stream.WriteByte);
    private static byte[] ReadIBinarySerializableData(this Stream stream)
